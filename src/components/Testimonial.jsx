            ...
            <div className="relative overflow-hidden">
              ...
              >
                {testimonials.map((testimonial, index) => (
                  ...
                  >
                    <div className="bg-white rounded-3xl p-6 md:p-8 lg:p-10 shadow-2xl max-w-lg mx-auto relative overflow-hidden min-h-[350px] md:min-h-[400px] lg:min-h-[450px] flex flex-col justify-center">
                      {/* Quote Icon */}
